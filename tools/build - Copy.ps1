...
if ($VS2019) {
  cmake -G "Visual Studio 16 2019" -A x64 --log-level=TRACE -Wdev $REPO_ROOT
  #cmake -G "Visual Studio 16 2019" -A x64 --host=x64 $REPO_ROOT
}else {
  #cmake -G "Visual Studio 16 2019" -A x64 --log-level=TRACE -Wdev --host=x64 $REPO_ROOT
  cmake -G "Visual Studio 15 2017 Win64" $REPO_ROOT
}
